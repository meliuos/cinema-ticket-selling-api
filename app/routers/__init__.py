...
from app.routers.seat_reservation import router as seat_reservation_router
...
from app.routers.cinema_favorites import router as cinema_favorites_router
from app.routers.movie_favorites import router as movie_favorites_router
